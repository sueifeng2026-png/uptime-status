...
Here are 5 alternatives that won't break the bank — including one I built myself.
...
Upptime is clever — it uses GitHub Actions as a cron scheduler and GitHub Pages for the status page. Free and clever, but limited by GitHub's rate limits and Actions minutes.
